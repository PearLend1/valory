...
import SellerAgentMatch from "./pages/SellerAgentMatch";
...
function Router() {
  return (
    <Switch>
      ...
      <Route path={"/sell/agents"} component={SellerAgentMatch} />
      <Route path={"/sell/dashboard"} component={SellerDashboard} />
