    ...
    <div className="min-h-screen bg-slate-950 text-foreground">
      ...
      <nav className="border-b border-slate-800 bg-slate-950/80 backdrop-blur-md sticky top-0 z-40">
        <div className="max-w-4xl mx-auto px-4 py-4 flex items-center justify-between">
          ...
          <h1 className="text-lg font-bold text-white">Cookie Policy</h1>
          <div className="w-16" />
        </div>
      </nav>
      ...
      <div className="max-w-4xl mx-auto px-4 py-12 md:py-16">
        <div className="space-y-8">
          <div>
            <h2 className="text-4xl md:text-5xl font-bold text-white mb-2">Cookie Policy</h2>
          ...
          <div className="prose prose-invert max-w-none">
            <p className="text-foreground/75 text-base leading-relaxed">
              This cookie policy explains how Valory uses cookies and similar technologies. 
