    ...
    <div className="min-h-screen bg-slate-950 text-foreground">
      ...
      <div className="max-w-4xl mx-auto px-4 py-12 md:py-16">
        <div className="space-y-8">
          <div>
            <h2 className="text-4xl md:text-5xl font-bold text-white mb-2">Terms of Service</h2>
          ...
          <div className="prose prose-invert max-w-none">
            <p className="text-foreground/75 text-base leading-relaxed">
              These terms of service govern your use of the Valory platform. 
              Full terms coming soon — contact{' '}
